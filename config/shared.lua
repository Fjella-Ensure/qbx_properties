return {
    ...
    -- Rental config
    rentalConfig = {
        enabled = true, -- Enable rental system for new chars (set to false if u just wanna use qbx_spawn thingy for new chars)
        defaultRentInterval = 168, -- 7 days in hours
        defaultRentPrice = 500, -- Default rent price per interval, set to 0 if u wanna do free
